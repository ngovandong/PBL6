...
class SearchedHotelItem extends StatelessWidget {
  const SearchedHotelItem({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Expanded(child: OutstandingUtilityAndPrice())
        ],
      ),
    );
  }
...
class OutstandingUtilityAndPrice extends StatelessWidget {
  const OutstandingUtilityAndPrice({super.key});
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    '3 ngày, 2 người',
                    style:
                        TextStyles.s14regularText.copyWith(color: Colors.white),
                  ),
                ),
              ),
              Expanded(
